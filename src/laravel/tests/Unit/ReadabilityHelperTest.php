...
class ReadabilityHelperTest extends TestCase
{
    public function testReadabilityHelper(): void
    {
        ...
        $readabilityObject = $helper->getResult();
        $this->assertObjectHasProperty('flesch', $readabilityObject);
    }
